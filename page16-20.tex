...
\underline{No}: 
$\Lambda = k[x]/\langle x^2\rangle \ncong k\G$ for all quivers $\G$. 

Have: $\dim_{k}\Lambda = 2$ and $\Lambda$ is not semisimple.

Assume that  $\Lambda \cong k\G$.

$2 = \dim_kk\G \ge \text{\# vertices in } \G.$
